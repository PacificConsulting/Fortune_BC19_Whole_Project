codeunit 50000 "Amount In Words"
{
    trigger OnRun()
    begin
    ...
    //PCPL-0070 << Create new function for remove Paisa word from Amount in words.
    procedure FormatNoTextWithoutPaisa(var NoText: array[2] of Text[80]; No: Decimal; CurrencyCode: Code[10])
    var
        Currency: Record Currency;
        PrintExponent: Boolean;
        NoTextIndex: Integer;
    ...
    begin
        ...
        if CurrencyCode <> '' then begin
            ...
            //AddToNoText(NoText, NoTextIndex, PrintExponent, RupeesLbl); //PCPL-064
            // AddToNoText(NoText, NoTextIndex, PrintExponent, ''); //PCPL-064
        ...
        if (CurrencyCode <> '') then
            ...
            AddToNoText(NoText, NoTextIndex, PrintExponent, WithoutPaisalbl);
    End;
    //PCPL-0070 >> Create new function for remove Paisa word from Amount in words.
