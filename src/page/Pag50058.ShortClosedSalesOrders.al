page 50058 "Short Closed Sales Orders"
{
    PageType = List;
    SourceTable = "Sales Line";
    SourceTableView = WHERE(IsShortClosed = FILTER(true));
    ApplicationArea = all;
    UsageCategory = Lists;
    ...
    layout
    {
        area(content)
        {
            repeater(Group)
            {
                ...
                field(IsShortClosed; IsShortClosed)
                {
                    ApplicationArea = All;
                }
    ...
    begin
        ...
        RecSH.SETRANGE(RecSH."Short Closed",TRUE);
        IF RecSH.FINDSET THEN
          REPEAT
            IF RecSH."Short Closed" = TRUE THEN
