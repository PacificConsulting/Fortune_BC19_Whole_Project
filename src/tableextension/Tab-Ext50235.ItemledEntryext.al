tableextension 50235 "Item_led_Entry_ext" extends "Item Ledger Entry"
{
    ...
    fields
    {
        ...
        field(50026; "Vendor Description"; Text[50])
        {
            Description = 'CCIT';
        }
        field(50027; "Item Description"; Text[50])
        {
            Description = 'CCIT';
        }
        ...
        field(50124; "DiscountRpt Boolean"; Boolean)
        {
            Description = 'CCIT';
        }
        field(50125; "Custom Duty Amount1"; Decimal)
        {
            DecimalPlaces = 0 : 3;
            Description = 'CCIT';
            MinValue = 0;
    ...
    keys
    {
        ...
        //Unsupported feature: PropertyChange on ""Item No.,Entry Type,Posting Date,Location Code"(Key)". Please convert manually.

        key(KeyExt1; "Item No.", "Document No.", "Location Code", "Lot No.")
        {
        }
        key(KeyExt2; "Item No.", "Location Code")
        {
            SumIndexFields = Quantity;
        }
        key(KeyExt3; "Item No.", "Source No.", "Location Code")
        {
        }
        key(KeyExt4; "Item No.", "Lot No.")
        {
        }
        key(KeyExt5; "Item No.", "Entry Type")
        {
            SumIndexFields = Quantity, "Remaining Quantity";
        }
        key(KeyExt6; "Source No.", "Item No.", "Posting Date")
        {
        }
        key(KeyExt7; "Order No.", "Order Line No.", "Item No.", "Posting Date")
        {
        }
    }
