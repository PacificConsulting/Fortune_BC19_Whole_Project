report 50178 "Transfer Registersold"
{
        ...
        dataitem(ILE_Shipment; "Item Ledger Entry")
        {
            ...
            dataitem(ILE_Receipt; "Item Ledger Entry")
            {
                ...
                begin
                    ...
                    IF TxtShorting <> ILE_Receipt."Document No." + ILE_Receipt."Item No." + ILE_Receipt."Lot No." + FORMAT(ILE_Receipt."Order Line No.") THEN BEGIN /* (ItemNo<> ILE_Receipt."Item No.") AND (DoceNo<>ILE_Receipt."Document No.") THEN*/
            ...
            begin
                ...
                IF RecTransShipLine.FINDFIRST THEN BEGIN
                    value := RecTransShipLine."Unit Price" * ABS(ILE_Shipment.Quantity);
                    IGST2 := 0;//(value * RecTransShipLine."GST %")/100; //PCPL/MIG/NSW Filed not Exist in BC18
    ...
    begin
        ...
        IF cnt <> 1 THEN BEGIN
            ...
            MakeExcelDataBody_Shipment2; // rdk 091019
                                         /*
