report 50052 "Purchase Debit Note"
{
    // version CCIT-JAGA

    DefaultLayout = RDLC;
    RDLCLayout = 'src/reportlayout/Purchase Debit Note.rdl';
    ApplicationArea = all;
    ...
    dataset
    {
        dataitem("Purch. Cr. Memo Hdr."; "Purch. Cr. Memo Hdr.")
        {
            ...
            dataitem("Purch. Cr. Memo Line"; "Purch. Cr. Memo Line")
            {
                ...
                column(LineDiscountAmount_PurchCrMemoLine; "Purch. Cr. Memo Line"."Line Discount Amount")
                {
                }
                        ...
                        begin
                            ...
                            IF RecPCML.FINDSET THEN
                                REPEAT
                                    ...
                                    UnitCost := RecPCML."Direct Unit Cost";
                            ...
                            TotalValueAftDiscount := ROUND(TotalValueAftDiscount, 0.01, '=');
                            ...
                            IF RecPCML1.FINDFIRST THEN
                                REPEAT
                                        IF GSTJurType = 'Intrastate' THEN BEGIN
                                            CGSTRate := 0;// RecPCML1."GST %"/2;
                                            CGSTAmt := TotalValueAftDiscount * (CGSTRate / 100);
                                        END
                                        ELSE
                                            IF GSTJurType = 'Interstate' THEN BEGIN
                                                IGSTRate := 0;//RecPCML1."GST %";
                            ...
                            */
                            ...
                            IF ("Return Receipt Line"."GST Jurisdiction Type" = "Return Receipt Line"."GST Jurisdiction Type"::Intrastate) THEN BEGIN
                                  CGSTRate := "Return Receipt Line"."GST %"/2;
                                  CGSTAmt := "Return Receipt Line"."Total GST Amount" / 2;
                                  SGSTAmt := "Return Receipt Line"."Total GST Amount" /2;
                            END
                            ELSE IF ("Return Receipt Line"."GST Jurisdiction Type" = "Return Receipt Line"."GST Jurisdiction Type"::Interstate) THEN BEGIN

                                  IGSTRate := "Return Receipt Line"."GST %";
                                  IGSTAmt := "Return Receipt Line"."Total GST Amount";
                            END;
