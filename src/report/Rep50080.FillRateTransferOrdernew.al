report 50080 "Fill Rate Transfer Ordernew"
{
    ...
    begin
        ...
        ExcelBuf.AddColumn("Transfer Shipment Line".Amount, FALSE, '', FALSE, FALSE, FALSE, '', ExcelBuf."Cell Type"::Number);
    ...
    begin
        ...
        ExcelBuf.AddColumn(ROUND("Transfer Line".Amount, 0.01, '='), FALSE, '', FALSE, FALSE, FALSE, '', ExcelBuf."Cell Type"::Number);
        ExcelBuf.AddColumn('', FALSE, '', FALSE, FALSE, FALSE, '', ExcelBuf."Cell Type"::Text);
