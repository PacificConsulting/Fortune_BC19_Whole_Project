report 50043 "Stock Ageing Report-Excel1"
{
    // version CCIT-JAGA
        ...
        dataitem("Item Ledger Entry"; "Item Ledger Entry")
        {
            ...
            begin
                ...
                */
                ...
                RecILE3.SETRANGE("Posting Date", 19990101D, To_Date);
                ...
                */
                ...
                IF CurrShorting <> CurrItem + CurrBatch THEN BEGIN
                    ...
                    REPEAT
                        ...
                        IF RecItem.FINDFIRST THEN
                            REPEAT
                                ...
                                RecILE2.SETRANGE(RecILE2."Posting Date", 19990101D, To_Date);
            ...
            begin
                ...
                IF (To_Date <> 0D) THEN
                    ...
                    "Item Ledger Entry".SETRANGE("Item Ledger Entry"."Posting Date", 19990101D, To_Date);
            end;
        }
    }
    ...
    begin
        ...
        IF RecLoc.FINDSET THEN
            REPEAT
                ...
                //RecILE2.SETRANGE(RecILE2."Entry No.","Item Ledger Entry"."Entry No.");
                //RecILE2.SETRANGE(RecILE2."Posting Date",From_Date,To_Date);
                RecILE2.SETRANGE(RecILE2."Posting Date", 99990101D, To_Date); //010199D
    ...
    begin
        ...
        RecILE33.SETRANGE(RecILE33."Posting Date", 19990101D, To_Date); //010199D
        IF LocCode <> '' THEN
