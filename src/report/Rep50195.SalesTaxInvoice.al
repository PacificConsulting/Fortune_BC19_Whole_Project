report 50195 "Sales Tax Invoice New"
{
            ...
            dataitem(CopyLoop; Integer)
            {
                ...
                dataitem(PageLoop; Integer)
                {
                    ...
                    dataitem("Sales Invoice Line"; "Sales Invoice Line")
                    {
                        ...
                        column(TCSPer; '')//"Sales Invoice Line"."TDS/TCS %")
                        {
                        }
                        column(TCSAmount; 0)//"Sales Invoice Line"."TDS/TCS Amount")
                        {
                        }
                        column(CGST; CGST)
                        {
                        ...
                        begin
                            ...
                            IF RecItem.GET("Sales Invoice Line"."No.") THEN BEGIN
                                ...
                                MRP_Price := 0;//RecItem."MRP Price";
                                               // rdk 180919 -
                                IF RecItem.Tolerance THEN BEGIN
                                    ConvPcsQty := '';
                                    TtlConvPcsQty := 0;
                                END
                                ELSE BEGIN
