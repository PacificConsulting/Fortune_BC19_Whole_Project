report 50114 "Stock Ageing Report-sss"
{
    // version CCIT-JAGA
        ...
        dataitem("Item Ledger Entry"; "Item Ledger Entry")
        {
            ...
            begin
                ...
                */
                ...
                RecILE3.SETRANGE("Posting Date", 20200111D, To_Date);//CCIT-021120//PCPL/MIG/NSW Filed not Exist in BC18
    ...
    begin
        ...
        IF RecLoc.FINDSET THEN
            REPEAT
                ...
                //RecILE2.SETRANGE(RecILE2."Posting Date",From_Date,To_Date);
                //RecILE2.SETRANGE(RecILE2."Posting Date",010199D,To_Date);
                RecILE2.SETRANGE(RecILE2."Posting Date", 20200111D, To_Date); //CCIT-031120  //PCPL/MIG/NSW Filed not Exist in BC18
    ...
    begin
        ...
        RecILE33.SETRANGE(RecILE33."Posting Date", 20200111D, To_Date);//CCIT-031120 //PCPL/MIG/NSW Filed not Exist in BC18
        IF LocCode <> '' THEN
