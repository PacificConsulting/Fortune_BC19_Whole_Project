report 50093 "Sales Register - DR"
{
    // version CCIT-Harshal

    DefaultLayout = RDLC;
    RDLCLayout = 'src/reportlayout/Sales Register - DR.rdl';
    ApplicationArea = all;
    ...
    dataset
    {
        dataitem("Customer Posting Group"; "Customer Posting Group")
        {
            ...
            column(StateCode; '')// RecComp.State)
            {
            }
                    ...
                    IF RecSalesInvLine.FINDFIRST THEN
                        REPEAT
                            ...
                            IF NOT RecBuffer.FINDFIRST THEN BEGIN
                                ...
                                RecBuffer."Amount To Customer" := 0;// RecSalesInvLine."Amount To Customer"; //PCPL/MIG/NSW Filed not Exist in BC18
                                ...
                                RecStae.RESET;
                                RecStae.SETRANGE(Code, RecLoc."State Code");
                    ...
                    IF RecSalesCrLine.FINDFIRST THEN
                        REPEAT
                            ...
                            IF NOT RecBuffer1.FINDFIRST THEN BEGIN
                                ...
                                RecBuffer1."Amount To Customer" := 0;//RecSalesCrLine."Amount To Customer"; //PCPL/MIG/NSW Filed not Exist in BC18
                                ...
                                RecBuffer1.Narration := "Sales Cr.Memo Header"."Reason Code";
                                ...
                                RecStae1.RESET;
                                RecStae1.SETRANGE(Code, RecLoc."State Code");
