report 50120 "Change Document No."
{
    ...
    Permissions = TableData 17 = rimd,
                  ...
                  TableData 5802 = rimd,
                  TableData 6508 = rimd,
                  //TableData 13760=rimd, //PCPL/MIG/NSW Filed not Exist in BC18
                  //TableData 13798=rimd,
        ...
        dataitem("Temp Document Change"; "Temp Document Change")
        {
            ...
            dataitem("Detailed GST Ledger Entry"; "Detailed GST Ledger Entry")
            {
                ...
                begin
                    ...
                    //"Detailed GST Ledger Entry"."Original Doc. No." := "Temp Document Change"."New Document No."; //PCPL/MIG/NSW Filed not Exist in BC18
            ...
            dataitem("Sales Invoice Line"; "Sales Invoice Line")
            {
                ...
                begin
                    ...
                    //ValueEntryRelation.SETRANGE("Source RowId",OldString); //PCPL/MIG/NSW Filed not Exist in BC18
