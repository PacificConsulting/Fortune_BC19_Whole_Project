report 50087 "Item Customer MoM- Range"
{
    // version RDK in use

    DefaultLayout = RDLC;
    RDLCLayout = 'src/reportlayout/Item Customer MoM- Range.rdl';
        ...
        dataitem(Itm; Item)
        {
            ...
            dataitem(SIL; "Sales Invoice Line")
            {
                ...
                begin
                    ...
                    IF NOT Temp_CustItemMom.GET(SIL."No.", SIL."Sell-to Customer No.") THEN BEGIN
                        Temp_CustItemMom.INIT;
                        Temp_CustItemMom."Code 1" := SIL."No.";
                        Temp_CustItemMom."Code 2" := SIL."Sell-to Customer No.";
                ...
                begin
                    ...
                    IF LocCodeText <> '' THEN
                        SIL.SETFILTER(SIL."Location Code", LocCodeText);
            ...
            dataitem(SCML; "Sales Cr.Memo Line")
            {
                ...
                begin
                    ...
                    IF NOT Temp_CustItemMom.GET(SCML."No.", SCML."Sell-to Customer No.") THEN BEGIN
                        Temp_CustItemMom.INIT;
                        Temp_CustItemMom."Code 1" := SCML."No.";
                        Temp_CustItemMom."Code 2" := SCML."Sell-to Customer No.";
                ...
                begin
                    ...
                    IF LocCodeText <> '' THEN
                        SCML.SETFILTER(SCML."Location Code", LocCodeText);
    ...
    begin
        //ExcelBuf.CreateBookAndOpenExcel('E:\Reports\ItemCustMoM.xlsx', 'ItemCustMoM', 'ItemCustMoM', COMPANYNAME, USERID);
        ExcelBuf.CreateBookAndOpenExcel('D:\Reports\ItemCustMoM.xlsx', 'ItemCustMoM', 'ItemCustMoM', COMPANYNAME, USERID);
    ...
    begin
        ExcelBuf.NewRow;
        ExcelBuf.AddColumn('Item Customer Month On Month', FALSE, '', TRUE, FALSE, TRUE, '', ExcelBuf."Cell Type"::Text);
        ExcelBuf.NewRow;
        ...
        FOR MnthCtr := 1 TO Months DO BEGIN
            ...
            ExcelBuf.AddColumn(MonthDateChr[MnthCtr] + ' Qty PCS', FALSE, '', TRUE, FALSE, TRUE, '', ExcelBuf."Cell Type"::Text);
    ...
    begin
        ...
        IF Rec_Item.GET(Temp_CustItemMom."Code 1") THEN
        ...
        IF Rec_Cust.GET(Temp_CustItemMom."Code 2") THEN BEGIN
        ...
        FOR MnthCtr := 1 TO Months DO BEGIN
            ...
            ExcelBuf.AddColumn(FldNoPCQty[MnthCtr], FALSE, '', FALSE, FALSE, FALSE, '#,##0.000', ExcelBuf."Cell Type"::Number);
