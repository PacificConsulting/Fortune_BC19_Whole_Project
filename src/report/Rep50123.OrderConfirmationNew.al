report 50123 "Order Confirmation GST New"
{
    DefaultLayout = RDLC;
    ...
    dataset
    {
        dataitem("Sales Header"; "Sales Header")
        {
            ...
            column(LocationVarAdd2; LocationVar."Address 2")
            {

            }

            column(LocationVarAdd; LocationVar.Address)
            {

            }

            column(LocationVarCity; LocationVar.City)
            {

            }
            column(LocationVarPostCode; LocationVar."Post Code")
            {

            }
            column(LocationVarPhNo; LocationVar."Phone No.")
            {

            }
            column(LocationVarEmail; LocationVar."E-Mail")
            {
            ...
            column(Ship_to_Address_2; Shiptoadd1)
            {
            }
            ...
            column(Ship_to_Contact; ShiptoContact)
            {
            }
            ...
            dataitem(CopyLoop; Integer)
            {
                ...
                dataitem(PageLoop; Integer)
                {
                    ...
                    dataitem(RoundLoop; Integer)
                    {
                        ...
                        Column(MRPPRice; "Sales Line"."MRP Price")
                        {

                        }

                        column(QtyInPCS; "Sales Line"."Main Quantity in PCS")
                        {
                        ...
                        column(UnitPricePcs; UnitPricePcs)
                        {
                        ...
                        begin
                            ...
                            //UnitPricePcs:="Sales Line".line a//Nirmal

                            ITUOM.reset;
                            ITUOM.SetRange("Item No.", TempSalesLine."No.");
                            IF ITUOM.FindFirst() then
                                UnitPricePcs := ITUOM.Weight;
            ...
            begin
                ...
                IF "Sales Header"."Ship-to Code" <> '' then begin
                    ...
                    Shiptoadd1 := "Ship-to Address 2";
                    Shiptocity := "Ship-to City";
                    Shiptopostcode := "Ship-to Post Code";
                    ShiptoContact := "Ship-to Contact";
                    ShipCap := 'Ship To Address';
                end;
                //Nirmal
                IF LocationVar.Get("Sales Header"."Location Code") then;
    ...
    var
        LocationVar: record 14;
        UnitPricePcs: decimal;
        ShipCap: text[20];
        Shiptoname: Text[50];
        Shiptoadd: Text[250];
        Shiptoadd1: Text[250];
